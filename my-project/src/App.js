  ...
  return (
    <div class="text-white"ref={containerRef}>
      ...
      <div class="grid grid-cols-3 w-full min-h-screen">
        ...
        <div class=" p-4 mb-6">
          <input type="text" id="input-group-1" class=" ml-2 bg-[#121A2F] text-lg border rounded-lg block w-1/5 ps-3 p-3  dark:bg-[#121A2F] dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="project name"></input>
          </div>
          <div class="p-4">
            <Slides/>
